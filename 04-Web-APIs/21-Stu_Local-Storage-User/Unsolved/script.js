...
function renderLastRegistered() {
  ...
  if (localStorage.getItem("uPassword")==null || localStorage.getItem("uEmail")==null) {
    return;
    }
    else {
      userEmailSpan.textContent=localStorage.getItem("uEmail");
      userPasswordSpan.textContent=localStorage.getItem("uPassword");
    }
  }
